...
public class repondre_reclamation extends Activity  {
	
	String URL = "http://10.0.2.2/pfe/Android/repondre_reclamation.php" ;
	EditText destinataire,reponse,sujet;
	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
		setContentView(R.layout.repondre_reclamation);
		
		destinataire=(EditText) findViewById(R.id.ed_dest_rep5);
		reponse=(EditText) findViewById(R.id.editText1_reponsee5);
		sujet=(EditText) findViewById(R.id.editText1_sujett5);
		Button envoyer=(Button) findViewById(R.id.button1_repondree5);
		 ...
		 String result =null;
	   		...
	   		nameValuePairs.add(new BasicNameValuePair("id_visiteur",reclamation.id_visiteur));
	   		...
	   		Toast.makeText(repondre_reclamation.this, "Verifier vos cordonnées", Toast.LENGTH_LONG).show();
	   		}
	   		//
	   		...
	   		envoyer.setOnClickListener(new OnClickListener() {
				public void onClick(View v) {
					...
					emailIntent.putExtra(android.content.Intent.EXTRA_TEXT,
							reponse.getText());
					repondre_reclamation.this.startActivity(Intent.createChooser(emailIntent,
							"Send mail..."));
